...
# Chrome 웹 드라이버 생성
driver = webdriver.Chrome('C:/Users/student.M703/login/chromedriver.exe', chrome_options=options)
...
user_id.send_keys('???@???')  # Id를 인자로 받음

user_pwd = driver.find_element_by_id('userPwd')
user_pwd.send_keys('???')  # Password를 인자로 받음
